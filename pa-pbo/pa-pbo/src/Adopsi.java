public class Adopsi {
    ...
    public void tampilkanDetail() {
        System.out.println("📋 ID Adopsi: " + idAdopsi);
        System.out.println("👤 Pengadopsi: " + namaPengadopsi + " | 📱 No. HP: " + noHp);
        System.out.println("📅 Tgl Adopsi: " + tanggalAdopsi + " | 🚪 Tgl Keluar: " + tanggalKeluar);
        System.out.println("🐈 Kucing: " + kucing.getNama() + " (ID: " + kucing.getId() + ", Kandang: " + kucing.getNomorKandang() + ")");
        System.out.println("--------------------------------------------------");
    }
}